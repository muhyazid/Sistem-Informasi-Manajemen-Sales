...
$(function () {
    ...
    function showNotification(message, type) {
        new Noty({
            ...
            theme: "sunset",
            layout: "topRight",
            timeout: 3000, // Durasi tampilan notifikasi dalam milidetik (misal: 3000 = 3 detik)
        }).show();
    }

    // Contoh penggunaan notifikasi ketika menambah data
    showNotification("Data berhasil ditambahkan.", "success");

    // Contoh penggunaan notifikasi ketika mengedit data
    showNotification("Data berhasil diubah.", "info");

    // Contoh penggunaan notifikasi ketika menghapus data
